...
$result = fetchpostseason($startpoint, $limit);
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Post-season</h3>
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href="<?php echo "ViewPostseasonDetails.php?RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                    </tr>  
                                                <?php } ?>
                                    ...
                                    <div  class="row">
                                        ...
                                        <?php
                                        echo pagination($query, $limit, $page, "postseason.php?");
                                        ?>
                    ...
                    <div id="list-toggle"  class="col-md-3">
                        ...
                        <div class="list-group">
                            ...
                            <a href="ManagePostseason.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add New Post-Season Data </a>
