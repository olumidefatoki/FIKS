                    ...
                    <div class="row">
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdcolor"><?php echo $result[0]['Name']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> User Name</td>
                                                <td class="tdcolor"><?php echo $result[0]['UserName']; ?></td>
                                            </tr>
                                             <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i>User Type</td>
                                                <td class="tdcolor"><?php echo $result[0]['UserType']; ?></td>
                                            </tr>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="<?php echo" ../Controller/RequestScript.php?ResetPassword&userId=$ID&username=$userName&name=$name"?>"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Reset Password</a>
