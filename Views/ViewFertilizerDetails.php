...
if (isset($_GET['RecID'])  && isset($_SESSION['username'])) {
    ...
    $id = $_GET['RecID'];    
    $result = fetchfertilizerDetails($id);
    $ID= $result[0]['ID'];    
}
else {
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Fertizer Details</h3>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>					
                                                <td  class="tdtext" ><i class="fa fa-tags"></i> Fertizer Name</td>
                                                <td class="tdcolor"><?php echo ucwords($result[0]['Name']); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Fertizer Description</td>
                                                <td class="tdcolor"><?php echo $result[0]['fertilizerDescription']; ?> </td>
                                            </tr>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="ManageFertilizer.php?action=Add"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Add Fertilizer</a>
                                <a href= "<?php  echo "ManageFertilizer.php?action=Update&id=$ID"; ?>"  class="list-group-item sync-request"><i class="glyphicon glyphicon-edit"></i> Edit Fertilizer</a>
                            </div>
                            <?php } ?> 
                        </div>
                    </div>
