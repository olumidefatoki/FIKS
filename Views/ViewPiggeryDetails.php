...
if (isset($_GET['RecID']) && isset($_SESSION['username'])) {
	...
	if(count($result) > 0)
	{
		 ...
		 $HousingEquipment= $result[0]['HousingEquipment'];
		 $BreedsBreeding = $result[0]['BreedsBreeding'];
		 $PigManagement= $result[0]['PigManagement'];
		 $FeedsFeeding= $result[0]['FeedsFeeding'];
		 $HealthManagement= $result[0]['HealthManagement'];
...
$list = splitContent($SiteSelection);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Housing Equipment </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($HousingEquipment);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Breeds Breeding  </td>
                                                <td class="tdcolor">
												<?php  
$list = splitContent($BreedsBreeding);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Pig Management </td>
                                                <td class="tdcolor"><?php 
	$list = splitContent($PigManagement);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Feeds Feeding </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($FeedsFeeding);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Health Management</td>
                                                <td class="tdcolor"><?php 
...
$list = splitContent($Processing);
        foreach ($list as $value) {
            echo $value .'<br/>';
											 ...
											 <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Marketing  </td>
                                                <td class="tdcolor"><?php 
            ...
            echo $value .'<br/>';
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="../Controller/RequestScript.php?tblName=poultry&action=Add"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Add New In-season Data</a>
