                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Pest Details</h3>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>					
                                                <td  class="tdtext" ><i class="fa fa-tags"></i> Pest Name</td>
                                                <td class="tdcolor"><?php echo ucwords($result[0]['Name']); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Pest Description</td>
                                                <td class="tdcolor"><?php echo $result[0]['pestDescription']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Pest Control</td>
                                                <td class="tdcolor"><?php echo $result[0]['pestControl']; ?></td>
                                            </tr>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="ManagePest.php?action=Add"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Add Pest</a>
                                <a href= "<?php  echo "ManagePest.php?action=Update&id=$ID"; ?>"  class="list-group-item sync-request"><i class="glyphicon glyphicon-edit"></i> Edit Pest</a>
                            </div>
                            <?php } ?> 
                        </div>
                    </div>
