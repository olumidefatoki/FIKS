...
if (isset($_SESSION['username'])) {
    ...
    if (isset($_POST['Search'])) {
        ...
        if (count($errorList) < 1) {
            ...
            $Crop = $_POST['Crop'];
            $CropName=fetchcropName($Crop);
            $result = fetchCroplifeCycleMsg($season, $POP, $language, $Crop);
            $displayTitle = true;
        }
        else {
            $displayTitle = false;
...
?>
                                        ...
                                        <form id="jvalidate" role="form" class="form-horizontal" method="post" action="CropLifeCycle.php">
                                            <div class="panel-body">                                    
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="SelectPOP.php"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Manage Package Of Practise </a>
