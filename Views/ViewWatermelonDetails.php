...
if (isset($_GET['RecID']) && isset($_SESSION['username'])) {
    ...
    $id = $_GET['RecID'];    
    $result = fetchWaterMelonDetails($id);
	if(count($result) > 0)
	{
		 $ID= $result[0]['ID'];
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">WaterMelon Details</h3>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i>  Land Preparetion </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Land_Preparetion);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Manuring</td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Manuring);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Aftercultivation  </td>
                                                <td class="tdcolor">
												<?php  
$list = splitContent($Aftercultivation);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Diseases Pest </td>
                                                <td class="tdcolor"><?php 
	$list = splitContent($Diseases_Pest);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }		?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> SeedRate Spacing</td>
                                                <td class="tdcolor"><?php 
$list = splitContent($SeedRate_Spacing);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
                                            </tr>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="../Controller/RequestScript.php?tblName=watermelon&action=Add"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Add New In-season Data</a>
