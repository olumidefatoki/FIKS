                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Diseases</h3>
                                                  
                                </div>
                                <div class="panel-body">
                                    <table id="CropList" class=" table datatable table-striped  table-bordered table-hover  dataTable no-footer" cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th style="width: 1%">S/N</th>
                                                <th style="width: 37%">Disease Name</th>
                                                <th style="width: 45%">Disease Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                 ...
                                                 <td> <?php  echo $value['AffectedCrop']; ?> </td>
                                                  <td> <a href="<?php echo "ViewDiseaseDetails.php?RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            <?php if(($privilege==1) || ($privilege==2)) { ?> 
                              <div class="list-group">
                                  ...
                                  <a href="ManageCrop.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add Disease</a>
                                                                        </div>
                            <?php  } ?> 
