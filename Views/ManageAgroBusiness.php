                        ...
                        <div class="col-md-9">
                                ...
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> 
                                        <?php if ($action=='Update') { 
                                           echo 'Update AgroBusiness Details';
                                       } else if ($action=='Add') {
                                           echo 'Add New AgroBusiness Details'; 
                                       }?>
                                       </h3>
                            ...
                            <?php if ( isset($errorlist) ) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="companyName" value="<?php if($action=='Update'){echo ucfirst($marketName);} ?>" />
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                             <textarea class="form-control" rows="5" name="companyAddress"> <?php if($action=='Update'){echo $marketAddress;} ?> </textarea>
