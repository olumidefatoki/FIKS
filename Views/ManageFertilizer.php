...
$recId= $result[0]['ID'];
$Name=$result[0]['Name'];
$description=$result[0]['fertilizerDescription'];
                                ...
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> 
                                       <?php if ($action=='Update') { 
                                           echo 'Update '.ucfirst($Name).' Details';
                                       } else if ($action=='Add') {
                                           echo 'Add New Crop'; 
                                       }?> </h3>
                            ...
                            <div class="block">
                                ...
                                <div class="panel-body">                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Fertilizer Name:</label>  
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="cropName" value="<?php if($action=='Update'){echo ucfirst($Name);} ?>" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Fertilizer Description:</label>  
                                        <div class="col-md-6">
