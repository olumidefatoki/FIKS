                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Fadama Production Cluster (FPC) Details</h3>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Fadama Production Cluster (FPC) Name </td>
                                                <td class="tdcolor"><?php echo $result[0]['FCAName']; ?></td>
                                            </tr>
                                             <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i>Fadam  Production Cluster (FPC) Leader Name</td>
                                                <td class="tdcolor"><?php echo $result[0]['groupLeadName']; ?></td>
                                            </tr>
                                             <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Fadama Production Cluster(FPC)  Leader Phone Number</td>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href= "<?php  echo "ManageFCA.php?action=Update&id=$ID"; ?>"  class="list-group-item sync-request"><i class="glyphicon glyphicon-edit"></i> Edit Fadama Production Cluster (FPC)</a>
                            </div>
                            <?php  } ?> 
                        </div>
                    </div>
