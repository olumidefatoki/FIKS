                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Agro Business Dealer</h3>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                 ...
                                                 <td> <?php  echo $value['address']; ?> </td>
                                                  <td> <a href="<?php echo "ViewAgroDealerDetails.php?RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                              ...
                              <div class="list-group">
                                  ...
                                  <a href="ManageMarket.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add Agro-Business Dealer</a>
                                                                        </div>
