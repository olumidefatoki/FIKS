                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Cabbage Details</h3>
...
$list = splitContent($SiteSelection);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Climate</td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Climate);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Cultivation </td>
                                                <td class="tdcolor">
												<?php  
	...
	$list = splitContent($Harvesting);
        foreach ($list as $value) {
            echo $value .'<br/>';
                                            ...
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Raising Seedlings</td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Raising_Seedlings);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Transplanting Spacing </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Transplanting_Spacing);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Manures Fertilizer </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Manures_Fertilizer);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
		</tr>
		<tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Weed Control Interculture  </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Weed_Control_Interculture);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
		</tr>
		<tr>
                                                ...
                                                <td class="tdcolor"><?php 
$list = splitContent($Diseases);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
                                            </tr>
											<tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Storage Yield </td>
                                                <td class="tdcolor"><?php 
$list = splitContent($Storage_Yield);
        foreach ($list as $value) {
            echo $value .'<br/>';
        }														?></td>
                                            </tr>
