...
if (isset($_GET['RecID'])  && isset($_SESSION['username'])) {
	...
	// $result = fetchBroadcastDetails($id);
     $pendingCount = fetchPendingCount($id);
...
<?php include'Topbar.php'; ?>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Uploaded File Summary</h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                          <tr>					
                                                <td  class="tdtext" ><i class="fa fa-tags"></i> Total Success Count </td>
                                                <td class="tdcolor"><?php echo $successCount; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Total Failed Record </td>
                                                <td class="tdcolor"><?php echo $failedCount; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Total Pending Record  </td>
                                                <td class="tdcolor"><?php  echo $pendingCount; ?></td>
                                            </tr>
  ...
  <div id="list-toggle"  class="col-md-3">
                              ...
                              <div class="list-group">
                                  ...
                                  <a href="#"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> View Uploaded Farmers list</a>
                                                                        </div>
