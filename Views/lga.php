...
if (isset($_POST['SearchFarmer']) && isset($_SESSION['username'])) 
    ...
    $startpoint = ($page * $limit) - $limit;
     ...
     if (isset($_POST['state']) && $_POST['state'] != '-1') {
        $state = $_POST['state'];
        $result = fetchStateLga($state, $startpoint, $limit);
    } else {
        $result = fetchAllLga($startpoint, $limit);
    }
    $query = $_SESSION['lgaquery'];
} else if (isset($_SESSION['username']) )
    {
    $username = $_SESSION['username'];
    $page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
    $startpoint = ($page * $limit) - $limit;
    if (!isset($_SESSION['lgaquery'])) {
        $result = fetchAllLga($startpoint, $limit);
    } else {
        $query = $_SESSION['lgaquery'];
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">LGA</h3>

                                </div>
                                <div class="panel-body">
                                    <div class="row">

                                        <form id="jvalidate" role="form" class="form-horizontal" method="post" action="lga.php">
                                            <div class="panel-body">                                    
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    </div> <div class="btn-group push-down-10">
...
<?php
echo pagination($query, $limit, $page, "lga.php?clear&");
?>
