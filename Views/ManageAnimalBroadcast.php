                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="panel-body">                                    
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Fadam Production Group(FPG)</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <button class="btn btn-success " type="submit" name="ScheduleAnimalBroadcast">Schedule</button>
                                    </div>                                                                                                                          
                                </div>                                               
                                </form>
...
//                                $("#Practiseloading").css("display","none");
                    ...
                    $("#POP").change(function(){	
                        ...
                        if (animal==-1) {
                            alert("Select an Animal Husbandry ");
                            return;
                        }
                        if (langID==-1) {
                        ...
                        var dataString ='broadcastAnimalID='+animal+'&animalMsgTitle='+id+'&animallangID='+langID;
