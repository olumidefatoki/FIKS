                    ...
                    <div class="row">
                                    ...
                                    <table id="CropList" class="datatable table table-striped table-bordered table-hover dataTable" cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 17%">Pest Name</th>
                                                <th style="width: 65%">Pest Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                 ...
                                                 <td> <?php  echo $value['pestDescription']; ?> </td>
                                                  <td> <a href="<?php echo "ViewPestDetails.php?ViewRecord=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
                      ...
                      <?php if(($privilege==1) || ($privilege==2)) { ?> 
                              <div class="list-group">
                                  ...
                                  <a href="ManagePest.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add Pest</a>
                                                                        </div>
                      <?php }?> 
