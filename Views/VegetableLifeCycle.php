                        ...
                        <div class="col-md-10">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Vegetable Crops</h3>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                  ...
                                                  <td> <a href="<?php echo "ViewVegetableLifeCycle.php?tblName=$tblName" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
