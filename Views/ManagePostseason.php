                            ...
                            <div class="block">
                                ...
                                <div class="panel-body">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name="procesing"> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Bulking & Delivery </label>  
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name="bulking_delivery"> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Farm Business Planing </label>  
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name="fbp"> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Farmer Financing </label>  
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name="ff"> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Raw Material Specification </label>  
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name="rms"> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <button class="btn btn-success" type="submit" name="<?php if ($action=='Update') { echo 'Updatepostseason';}else if ($action=='Add') { echo 'Addpostseason';} ?>"> <?php if ($action=='Update') { echo 'Update';}else if ($action=='Add') { echo 'Add';} ?></button>
                                    </div>                                                                                                                          
                                </div>                                               
                                </form>
