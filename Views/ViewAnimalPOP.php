...
if (isset($_SESSION['username']) && isset($_SESSION['username']) && $_GET['tblName']) {
     $username=$_SESSION['username'];  
   $tblName=  $_GET['tblName'];
$page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
$startpoint = ($page * $limit) - $limit;
$result = fetchAnimalPOP($tblName,$startpoint, $limit);
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"><?php  echo ucfirst($tblName).' Package of Practise';?></h3>
                                ...
                                <div class="panel-body">
                                        ...
                                        <table id="CropList" class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 25%">Access Channel </th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href="<?php echo "../Controller/RequestScript.php?tblName=$tblName&action=ViewDetails&RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                    </tr>  
                                                <?php } ?>
                                    ...
                                    <div  class="row">
                                        ...
                                        <?php
                                        echo pagination($query, $limit, $page, "inseason.php?");
                                        ?>
                    ...
                    <div id="list-toggle"  class="col-md-3">
                        ...
                        <div class="list-group">
                            ...
                            <a href="<?php echo "../Controller/RequestScript.php?tblName=$tblName&action=Add" ?>"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add New <?php  echo ucfirst($tblName);?> Data </a>
