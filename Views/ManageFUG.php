                        ...
                        <div class="col-md-9">
                                ...
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> 
                                       <?php if ($action=='Update') { 
                                           ...
                                           echo 'Add New Fadama Production Group (FPG)'; 
                                       }?> </h3>
                            ...
                            <div class="block">
                                ...
                                <div class="panel-body"> 
                                        ...
                                        <label class="col-md-5 col-xs-12 control-label">State</label>
                                        <div class="col-md-5 col-xs-12">                                                                                            
                                           <select class=" form-control" name="state" id="state">
                                            <option value="-1" >Select State</option>
                                              ...
                                              <input type="hidden" name="fugID" id="id" value="<?php if ($action == 'Update') {echo $id;} ?>"/>
                                        </div>
                                            <?php
                                            if (isset($errorlist)) {
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-5 col-xs-12 control-label">LGA</label>
                                        <div class="col-md-5 col-xs-12">                                                                                            
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-5 col-xs-12 control-label">Fadama Production Cluster (FPC)</label>
                                        <div class="col-md-5 col-xs-12">                                                                                            
                                            <select class="form-control" name="fca" id="fca">
                                                 <option value="-1" >Select FPC</option>                                                
                                            </select>                                           
                                        </div><?php
                                            if (isset($errorlist)) {
                                                foreach ($errorlist as $value) {
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Fadama Production Group (FPG) Name:</label>  
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="fugname" value="<?php if($action=='Update'){echo $result[0]['FUGName'];} ?>" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Fadama Production Group (FPG) Leader Name:</label>  
                                        <div class="col-md-5">
                                             <input type="text" class="form-control" name="fugleadername" value="<?php if($action=='Update'){echo $result[0]['groupLeadName'];} ?>"/>
                                            
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Fadama Production Group (FPG) Leader Phone No:</label>  
                                        <div class="col-md-5">
                                              <input type="text" class="form-control" name="fugleaderPhone" value="<?php if($action=='Update'){echo $result[0]['groupPhoneNo']; } ?>"/>
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <button class="btn btn-success" type="submit" name="<?php if ($action=='Update') { echo 'UpdateFUG';}else if ($action=='Add') { echo 'AddFUG';} ?>" > <?php if ($action=='Update') { echo 'Update';}else if ($action=='Add') { echo 'Add';} ?></button>
                                    </div>                                                                                                                          
                                </div>                                               
                                </form>
