...
if (isset($_GET['RecID']) && isset($_SESSION['username'])) {
    ...
    $id = $_GET['RecID'];    
    $result = fetchpreseasonDetails($id);
    $ID= $result[0]['ID'];
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Pre-season Details</h3>
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdcolor"><?php echo $result[0]['siteSelection']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Land Preparation </td>
                                                <td class="tdcolor"><?php echo $result[0]['landPreparation']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Ploughing </td>
                                                <td class="tdcolor"><?php echo $result[0]['ploughing']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Harrowing</td>
                                                <td class="tdcolor"><?php echo $result[0]['Harrowing']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> Ridging </td>
                                                <td class="tdcolor"><?php echo $result[0]['ridging']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> ExtraInfo1</td>
                                                <td class="tdcolor"><?php echo $result[0]['extraInfo1']; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> ExtraInfo2 </td>
                                                <td class="tdcolor"><?php echo $result[0]['extraInfo2']; ?> </td>
                                            </tr>
                                            <tr>
                                                <td class="tdtext" ><i class="fa fa-tags"></i> ExtraInfo3</td>
                                                <td class="tdcolor"><?php echo $result[0]['extraInfo3']; ?></td>
                                            </tr>
                        ...
                        <div id="list-toggle"  class="col-md-3">
                            ...
                            <div class="list-group">
                                ...
                                <a href="Managepreseason.php?action=Add"  class="list-group-item sync-request"><i class="glyphicon glyphicon-plus-sign"></i> Add New Pre-season Data</a>
                                <a href= "<?php  echo "#"; ?>"  class="list-group-item sync-request"><i class="glyphicon glyphicon-edit"></i> Edit Pre-season Data</a>
                            </div>
                        </div>
                    </div>
