...
include_once '../Controller/Pagination.php';
 if (isset($_SESSION['username'])) {
   ...
   $result=fetchAllBroadcast($startpoint, $limit);
    $query = $_SESSION['Broadcastquery'];
}
else
{
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Message Broadcast</h3>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                  <td style="width:2%">  <?php  echo $i; ?></td>
                                                   <td style="width:10%">  <?php  echo ucfirst($value['targetFarmer']); ?></td>
                                                 <td style="width:10%"> <?php  echo $value['targetGroup']; ?> </td>
                                                 <td style="width:20%">  <?php  echo ucfirst($value['Description']); ?></td>
                                                 <td style="width:20%"> <?php  echo $value['messageTitle']; ?> </td>
                                                 <td style="width:10%">  <?php  echo ucfirst($value['dateInserted']); ?></td>
                                                 
                                                  <td> <a href="<?php echo "ViewBroadcastDetails.php?RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
...
<?php
echo pagination($query, $limit, $page, "Broadcast.php?clear&");
?>
                        ...
                        <div id="list-toggle"  class="col-md-2">
                              ...
                              <div class="list-group">
                                  ...
                                  <a href="SelectBroadcast.php"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Schedule New  Broadcast</a>
                                                                        </div>
