                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="block">
                                ...
                                <form id="jvalidate" role="form" class="form-horizontal" method="post" action="inseason.php">
                                <div class="panel-body">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                             <textarea class="form-control" rows="5" name=""> <?php if($action=='Update'){echo $description;} ?> </textarea>
                                       </div>
                                    </div>
