                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Herbicides</h3>
                                    ...
                                    <table id="CropList" class="datatable table table-striped table-bordered table-hover dataTable" cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 17%">Herbicide Name</th>
                                                <th style="width: 65%">Herbicide Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($result as $key => $value) {
                                              ...
                                              <tr>
                                                 ...
                                                 <td> <?php  echo $value['herb_Usage']; ?> </td>
                                                  <td> <a href="<?php echo "ViewHerbDetails.php?RecId=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                </tr>  
                                           <?php   } ?>
                      ...
                      <?php if(($privilege==1) || ($privilege==2)) { ?> 
                              <div class="list-group">
                                  ...
                                  <a href="ManageHerb.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add Herbicide</a>
                                                                        </div>
                      <?php  } ?> 
