...
$result = fetchinseason($startpoint, $limit);
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Inseason</h3>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href="<?php echo "ViewInseasonDetails.php?RecID=$Id" ?>"><i class="glyphicon glyphicon-plus"></i> VIEW MORE</a> </td>
                                                    </tr>  
                                                <?php } ?>
                    ...
                    <div id="list-toggle"  class="col-md-3">
                        ...
                        <div class="list-group">
                            ...
                            <a href="Manageinseason.php?action=Add"   class="list-group-item "><i class="glyphicon glyphicon-plus-sign"></i> Add Inseason Data </a>
