...
$_SESSION['menuTableName']='pre_season';
$_SESSION['menuName']='pre_season';
$menuName=$_SESSION['menuName'];
    $page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
    $startpoint = ($page * $limit) - $limit;
    $cropName=$_POST['cropName'];
     $list=  entity::fetchCropPreseason($cropName,$startpoint,$limit);
...
$limit = 10;
   $startpoint = ($page * $limit) - $limit;
    if (!isset($_SESSION['query'])) {
      $list=  entity::fetchAllPreseason($startpoint,$limit);
      $listRow=mysql_num_rows($list);    
    }
     else {
        $query = $_SESSION['query'];
...
<div id="content">
  <div id="post">
      <div id="view">
        <div style="color:#044407; font-size:28px; margin-top:2px ; margin-bottom:10px;"><?php echo strtoupper($menuName); ?>
          <br />
         <font size="+1" color="#000"> Search</font><br />
         <form id="form1" name="form1" method="post" action="ViewPreSeasons.php">
           <input name="cropName" type="text" id="cropName" size="30" />
...
<table width="100%" cellpadding="5" cellspacing="1" class="recordTable" >
		 ...
		 for($i=0;$i<$listRow;$i++)
    {
          ...
          <tr id="<?php echo $bg; ?>">
            ...
            <td id="<?php echo $bg; ?>"><a href="<?php echo "../View/ViewPreSeasonRec.php?ViewRecord=$id" ?>"> View </a></td>
          </tr>
          <?php
		  }
		  }
          ...
          <div id="pagination">
          <?php
	echo pagination($query, $limit, $page, "ViewPreSeasons.php?");
?></div>
      </div>
      <div id="subMenu">
      <ul>
